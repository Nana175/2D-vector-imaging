...
class UNetPlusPlus_tanh(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, dropout_p=0.3):
        super(UNetPlusPlus_tanh, self).__init__()
        ...
        self.dec3_2 = self.conv_block(
            1024, 256
        )  # 256 (dec3_1) + 512 (dec4_2) + 256 (skip)

        self.upconv2 = nn.ConvTranspose2d(256, 128, kernel_size=2, stride=2)
        self.dec2_1 = self.conv_block(256, 128)  # 128 (upconv) + 128 (skip)
        self.dec2_2 = self.conv_block(
            512, 128
        )  # 128 (dec2_1) + 256 (dec3_2) + 128 (skip)
